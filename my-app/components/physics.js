...
const Physics = (entities, {touches, time, dispatch}) => {
    ...
    /*
    if (restart["ObstacleTop1"].body.position.x < -50) {
        const { pipeTop, pipeBottom } = getPipeSizePosPair();
        Matter.Body.setPosition(restart["ObstacleTop1"].body, pipeTop.pos);
        Matter.Body.setPosition(restart["ObstacleBottom1"].body, pipeBottom.pos);
      }
    */
